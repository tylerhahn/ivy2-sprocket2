...
## HP Sprocket 2 Support

This repository now includes support for the HP Sprocket 2 photo printer! See [README_SPROCKET2.md](README_SPROCKET2.md) for detailed documentation on using the HP Sprocket 2 printer.

### Quick Start for HP Sprocket 2

```python
from sprocket2 import Sprocket2Printer

printer = Sprocket2Printer()
printer.connect("XX:XX:XX:XX:XX:XX")  # Your printer's MAC address
